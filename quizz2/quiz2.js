const questions = [
    ...
    {
        text: "Para a função quadrática y = −2x² + 4x + 1, qual é a coordenada y do vértice?",
        options: [
    ...
    {
        text: "Qual é o valor de X para o qual a função f(x) = 2x² −8x + 6 atinge seu valor mínimo?",
        options: [
            { text: "X = -8", correct: false },
            { text: "X = 5", correct: false },
