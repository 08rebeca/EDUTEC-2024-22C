const questions = [
    ...
    {
        text: "Determine os valores de X1 e X2 para a equação quadrática abaixo: 4x² −4x −8 = 0",
        options: [
    ...
    {
        text: "Resolva a seguinte equação quadrática x² −5x + 6 = 0  e encontre as raízes X1 e X2:",
        options: [
